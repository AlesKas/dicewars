...
class Move:
    def __init__(self, command: Command, scores: Optional[List[int]]=None, children: List['Move']=list(), target_name: Optional[int]=None):
    ...
    @classmethod
    def other(cls, command, scores: Optional[List[int]]=None, next: Optional['Move']=None):
